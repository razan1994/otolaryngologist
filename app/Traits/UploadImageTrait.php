...
trait  UploadImageTrait
{
    ...
    function saveImageSvg($file, $folder)
    {
        ...
        $file_name =  time() . rand();
        $file->move($folder, $file_name.'.svg');
        return $folder.$file_name . '.svg';
    }

    // =========================================================================================
    //=================== new >> save file with original name as original ext ==================
    // =========================================================================================
    ...
    //     $file_name = $img_name.'.'.$img_ext_firstsearch;
    //     $orginal_image->move($upload_location, $file_name);
    //     return $upload_location . $file_name;
    // }


    // =========================================================================================
    //=================== old >> save file with original name as webp ==========================
    // =========================================================================================
    ...
    // =========================================================================================
    //=================== old >> save file with original name as webp and compress =============
    // =========================================================================================
