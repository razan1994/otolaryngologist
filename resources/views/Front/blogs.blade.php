...
@if($blogs->currentPage() == 1)
    ...
    @section('canonical')
        ...
        @else
            ...
            <link rel="alternate" href="https://otolaryngologist-jo.com/ar/مقالة-طبية" hreflang="ar-jo"/>
            <link rel="alternate" href="https://otolaryngologist-jo.com/en/blogs" hreflang="en-jo"/>
            <link rel="alternate" href="https://otolaryngologist-jo.com/ar/مقالة-طبية" hreflang="x-default"/>
        @endif
    @endsection
@else
    {{-- SEO SECTION --}}
    ...
    @section('canonical')
        ...
        @else
            ...
            <link rel="alternate" href="https://otolaryngologist-jo.com/ar/مقالة-طبية?{{ 'page=' . $blogs->currentPage() }}" hreflang="ar-jo"/>
            <link rel="alternate" href="https://otolaryngologist-jo.com/en/blogs?{{ 'page=' . $blogs->currentPage() }}" hreflang="en-jo"/>
            <link rel="alternate" href="https://otolaryngologist-jo.com/ar/مقالة-طبية?{{ 'page=' . $blogs->currentPage() }}" hreflang="x-default"/>
        @endif
    @endsection
@endif
                            ...
                            @for ($i = 1; $i <= 30; $i++)
                                <div class="swiper-slide">
                                    <a href="https://www.instagram.com/">
                                        <img src="{{ asset('front_end_style/assets/img/home1/Instagram/inst' . $i . '.jpg') }}" alt="">
                                    </a>
                                </div>
                            @endfor
                        </div>
