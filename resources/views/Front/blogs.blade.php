...
@section('page_title')
    ...
    @else
        {{ isset($seo_operation->seo_title) ? $seo_operation->seo_title : 'Undefined' }} - {{ __('front_end.page') }} {{ $blogs->currentPage() }}
    @endif
@endsection
...
@section('meta_desc')
    ...
    @else
        {{ isset($seo_operation->meta_desc) ? $seo_operation->meta_desc : 'Undefined' }} - {{ __('front_end.page') }} {{ $blogs->currentPage() }}
    @endif
@endsection
                            ...
                            <div class="recent-post-widget mb-20">
                                <div class="recent-post-img">
                                    <a href="{{ route('blog-details', $recentBlog->alias_name) }}">
                                        <img src="{{ asset($recentBlog->image) }}" alt="{{ $recentBlog->title }}" loading="lazy">
                                    </a>
                                </div>
