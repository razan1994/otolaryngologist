...
@section('canonical')
    @php
        $enUrl = 'https://www.otolaryngologist-jo.com/en/blogs/' . $news_blog->alias_name_en;
        $arUrl = 'https://www.otolaryngologist-jo.com/ar/مقالة-طبية/' . $news_blog->alias_name_ar;
        ...
        <div class="row g-lg-4 gy-5">
            <div class="col-lg-8">
                <div class="blog-thumb">
                    <img src="{{ asset($news_blog->image) }}" alt="{!! $news_blog->title !!}" loading="lazy">
                            ...
                            <div class="recent-post-widget mb-20">
                                <div class="recent-post-img">
                                    <a href="{{ route('blog-details', $recentBlog->alias_name) }}">
                                        <img src="{{ asset($recentBlog->image) }}" loading="lazy"
