                ...
                <div class="col-lg-6">
                    <div class="single-location">
                        <div class="title-and-view-btn">
                            ...
                            <a href="https://maps.app.goo.gl/Y3R5FyJnEZrkvuPR6" target="_blank" >{{__('front_end.View_Map')}}
                                <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8">
                                    <path d="M6.669 2.27202L0.94102 8L0 7.05898L5.72731 1.331H0.679478V0H8V7.32052H6.669V2.27202Z"/>
                                </svg>
                            </a>
    ...
    <script>
        function initMap() {
            ...
            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 12,
                center: {lat: 31.979921, lng: 35.918427}
            });


            var locations = [
                {lat: 31.959770804791454, lng: 35.964000950919996, title: '{{__('front_end.east_amman')}}'},
                {lat: 31.99807145183713, lng: 35.872853722085445, title: '{{__('front_end.west_amman')}}'}
            ];
