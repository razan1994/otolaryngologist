...
@section('canonical')
    @php
        $enUrl = 'https://www.otolaryngologist-jo.com/en/Contact-Us';
        $arUrl = 'https://www.otolaryngologist-jo.com/ar/اتصل-بنا';
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('front_end.nav_ContactUs') }}</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="container">
                ...
                <div class="row g-4 mb-40">
                    <div class="col-lg-5">
                        <div class="section-title mb-50">
                            <h6>{{ __('front_end.contct_title') }}</h6>
                        </div>
                        <div class="single-contact mb-40">
                            <div class="title">
                                <h6>{{ __('front_end.To_Know_More') }} </h6>
                            </div>
                            <div class="icon">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-inner mb-20">
                                            ...
                                            <label>
                                                {{ __('front_end.ContactUs_Subject') }}
                                            </label>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-inner mb-30">
                                            ...
                                            <label>
                                                {{ __('front_end.ContactUs_YourMessage') }}
                                            </label>

                                            <textarea name="message" class="form-control" id="message" cols="30" rows="5" required
                                                data-error="{{ __('front_end.ContactUs_error_name') }} {{ __('front_end.ContactUs_YourMessage') }}"
                                                placeholder="{{ __('front_end.ContactUs_YourMessage') }}">{{ old('message') }}</textarea>
                ...
                <div class="row g-4 justify-content-center mb-100">
                    <div class="col-lg-6">
                        <div class="single-location">
                            <div class="title-and-view-btn">
                                ...
                                <a href="https://maps.google.com/?q=31.957905,35.876591"
                                    target="_blank">{{ __('front_end.View_Map') }}
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="info">
                                        <a>{{ app()->getLocale() == 'ar' ? $contacts->address_ar : $contacts->address_en }}</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="single-location">
                            <div class="title-and-view-btn">
                                <h5>{{ __('front_end.east_amman_location') }}</h5>
                                <a href="https://maps.app.goo.gl/Y3R5FyJnEZrkvuPR6"
                                    target="_blank">{{ __('front_end.View_Map') }}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8"
                                        viewBox="0 0 8 8">
                                        <path
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="info">
                                        <a>{{ app()->getLocale() == 'ar' ? $contacts->address_ar2 : $contacts->address_en2 }}</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="swiper instagram-slider"
                                dir="{{ Config::get('app.locale') == 'ar' ? 'ltr' : 'rtl' }}">
...
"></a>
        ...
        <script async src="https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY&loading=async"></script>
        <script>
            function initMap() {
                ...
                var locations = [{
                        lat: 31.959770804791454,
                        lng: 35.964000950919996,
                        title: '{{ __('front_end.east_amman') }}'
                    },
                    {
                        lat: 31.99807145183713,
                        lng: 35.872853722085445,
                        title: '{{ __('front_end.west_amman') }}'
                    }
                ];
