...
@section('canonical')
    @php
        $enUrl = 'https://www.otolaryngologist-jo.com/en/Privacy-Policy';
        $arUrl = 'https://www.otolaryngologist-jo.com/ar/سياسة-الخصوصية';
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('front_end.PrivacyPolicy_Privacy') }}</li>
                </ol>
            </nav>
        </div>
    </div>
