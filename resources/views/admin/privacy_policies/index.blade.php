                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <i class="fas fa-user-secret"></i> All Privacy Policy
                            </li>
                                ...
                                @foreach ($privacy_policies as $index => $privacy_policy)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{ route('super_admin.privacy_policies-show', $privacy_policy->id) }}"
                                                class="mb-1 btn btn-sm btn-primary"><i class="mdi mdi-eye"></i></a>

                                            <a href="{{ route('super_admin.privacy_policies-edit', $privacy_policy->id) }}"
                                                class="mb-1 btn btn-sm btn-success"><i
                                                    class="mdi mdi-playlist-edit"></i></a>


                                            <a href="{{ route('super_admin.privacy_policies-softDelete', $privacy_policy->id) }}"
