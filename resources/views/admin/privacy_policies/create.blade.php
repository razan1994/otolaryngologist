                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Title AR: <strong
                                                            class="text-danger"> * @error('privacy_policy_title_ar') -
                                                                {{ $message }}
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="privacy_policy_title_ar"
                                                            ...
                                                            value="{{ old('privacy_policy_title_ar') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01">Title EN : <strong
                                                            class="text-danger"> * @error('privacy_policy_title_en') -
                                                                {{ $message }}
                                                            @enderror</strong></label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                        ...
                                                        <input type="text" name="privacy_policy_title_en" class="form-control @error('privacy_policy_title_en') is-invalid @enderror"
                                                            id="validationServer01" placeholder="Title EN"
                                                            value="{{ old('privacy_policy_title_en') }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea style="width: 90% !important" id="privacy_policy_des_ar" name="privacy_policy_des_ar"
                                                            class="form-control " rows="10">{{ old('privacy_policy_des_ar') }}</textarea>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea style="width: 90% !important" id="privacy_policy_des_en" name="privacy_policy_des_en"
                                                            class="form-control " rows="10">{{ old('privacy_policy_des_en') }}</textarea>
