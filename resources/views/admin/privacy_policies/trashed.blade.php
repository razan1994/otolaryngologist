        ...
        <div class="content">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.privacy_policies-index') }}">
                                    <i class="fas fa-user-secret"></i></span> All Privacy Policy
                                </a>
                            </li>

                            <li class="breadcrumb-item" aria-current="page"><i class="mdi mdi-delete"></i> All Privacy Policy Archived</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card card-default">
                <div class="card-header card-header-border-bottom">
                    <h2> List Privacy Policy Archived: </h2>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @if ($privacy_policies->count() > 0)
                                @foreach ($privacy_policies as $index => $privacy_policy)
                                    <tr>
                                        <td style="text-align: center">{!! isset($privacy_policy->privacy_policy_title_ar) ? $privacy_policy->privacy_policy_title_ar : "<span style='color:red;'>Undefined</span>" !!} </td>
                                        ...
                                        <td style="text-align: center">{!! isset($privacy_policy->privacy_policy_status) ? $privacy_policy->privacy_policy_status : "<span style='color:red;'>Undefined</span>" !!} </td>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{ route('super_admin.privacy_policies-softDeleteRestore', $privacy_policy->id) }}"
