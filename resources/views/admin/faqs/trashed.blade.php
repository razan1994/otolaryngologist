    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    <h1><i class="fas fa-user-md"></i> All FAQs Archived</h1>
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.faqs-index') }}">
                                    <i class="fas fa-spell-check"></i> All FAQs
                                </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page"><i
                                class="mdi mdi-delete"></i> All FAQs Archived
                            </li>
                        </ol>
                    </nav>
                </div>
                                    ...
                                    @foreach ($faqs as $index => $faq)
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <a href="{{ route('super_admin.faqs-softDeleteRestore', $faq->id) }}" class="unarchive mb-1 btn btn-sm btn-success"><i class="mdi mdi-redo-variant"></i></a>
