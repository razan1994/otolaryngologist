                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('super_admin.services-store') }}" method="POST"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <label class="text-dark font-weight-medium mb-3" > Service Details AR :
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <label class="text-dark font-weight-medium mb-3" > Service Details EN :
