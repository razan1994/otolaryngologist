                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('super_admin.services-update', [$service->id]) }}"
                                            ...
                                            <div class="form-row">
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select name="status" class="selectpicker" data-live-search="true" data-width="88%"
                                                                ...
                                                                <option value="2" @if ($service->status == '2') selected @endif>Inactive</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                {{-- Main Image --}}
                                                ...
                                                {{-- @lang('front_end.service_Details_AR') --}}
                                                <div class="col-md-12 mb-3">
                                                    <label class="text-dark font-weight-medium mb-3" > Details AR :
                                                        <strong class="text-danger"> * @error('desc_ar') - {{ $message }} @enderror</strong>
                                                    </label>
                                                    <textarea id="desc_ar" name="desc_ar" class="form-control ">{{ $service->desc_ar }}</textarea>
                                                </div>

                                                {{-- @lang('front_end.service_Details_EN') --}}
                                                <div class="col-md-12 mb-3">
                                                    <label class="text-dark font-weight-medium mb-3" > Details EN :
                                                        <strong class="text-danger">* @error('desc_en') - {{ $message }}@enderror</strong>
                                                    </label>
                                                    <textarea id="desc_en" name="desc_en" class="form-control" rows="10">{{ $service->desc_en }}</textarea>
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="image_title_text_ar" class="form-control @error('image_title_text_ar') is-invalid @enderror"
                                                            ...
                                                            value="{{ $service->image_title_text_ar }}">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="image_title_text_en" class="form-control @error('image_title_text_en') is-invalid @enderror"
                                                            ...
                                                            value="{{ $service->image_title_text_en }}">
                                                    </div>
                                                </div>
...
<div class="col-md-6 mb-3">
    ...
    <div class="input-group">
        ...
        <input type="text" name="h2_val_ar" class="form-control @error('image_title_text_ar') is-invalid @enderror"
            id="validationServer01" placeholder="H2 Ar"
            value="{{ $service->h2_val_ar }}">
        ...
        <input type="text" name="h2_val_en" class="form-control @error('h2_val_en') is-invalid @enderror"
            ...
            value="{{ $service->h2_val_en }}">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea  name="meta_desc_ar" rows="10" class="form-control" placeholder="Meta Desc AR">{{ $service->meta_desc_ar }}</textarea>
                                                </div>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea name="meta_desc_en" class="form-control" rows="10" placeholder="Meta Desc EN">{{ $service->meta_desc_en }}</textarea>
                                                </div>
                                                {{-- SEO Meta data AR --}}
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea name="keywords_ar" class="form-control" placeholder="Kewords AR">{{ $service->keywords_ar }}</textarea>
                                                </div>
                                                {{-- SEO Meta data EN --}}
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea name="keywords_en" class="form-control" placeholder="Kewords EN">{{ $service->keywords_en }}</textarea>
                                                </div>
                                                {{-- Redirect 301 AR --}}
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea name="redirect_301_ar" class="form-control" placeholder="Redirect 301 AR">{{ $service->redirect_301_ar }}</textarea>
                                                </div>
                                                {{-- Redirect 301 EN --}}
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea name="redirect_301_en" class="form-control" placeholder="Redirect 301 EN">{{ $service->redirect_301_en }}</textarea>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label class="text-dark font-weight-medium mb-3" > Tags :
                                                        <strong class="text-danger"> * @error('redirect_301_en') - {{ $message }} @enderror</strong>
                                                    </label>
                                                    <textarea name="tags" class="form-control" placeholder="enter , after your tag">{{ $service->tags }}</textarea>
                                                </div>
                                                @endif
