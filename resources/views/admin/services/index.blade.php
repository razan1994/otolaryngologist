    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                <div>
                    <a href="{{ route('super_admin.services-create') }}" class="mb-1 btn btn-primary"><i
                            class="mdi mdi-playlist-plus"></i> Add New</a>


                            <a href="{{ route('super_admin.services-showSoftDelete') }}" class="mb-1 btn btn-danger"><i
                                ...
                                @foreach ($services as $index => $service)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            {{ isset($service->created_at) ? $service->created_at : "<span style='color:red;'>Undefined</span>" }}
                                        </td>
                                        ...
                                        <td  style="text-align: center">
                                            ...
                                            <a href="{{ route('super_admin.services-show', $service->id) }}"
                                                class="mb-1 btn btn-sm btn-primary"><i class="mdi mdi-eye"></i></a>

                                            <a href="{{ route('super_admin.services-edit', $service->id) }}"
                                                class="mb-1 btn btn-sm btn-success"><i
                                                    class="mdi mdi-playlist-edit"></i></a>


                                            <a href="{{ route('super_admin.services-softDelete', $service->id) }}"
