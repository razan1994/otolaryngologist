        ...
        <div class="content">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.insurances-index') }}">
                                    <i class="far fa-newspaper"></i></span> All insurances
                                </a>
                            </li>

                            <li class="breadcrumb-item" aria-current="page" ><i class="mdi mdi-delete"></i> All insurances Archived </li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card card-default">
                <div class="card-header card-header-border-bottom">
                    <h2> List insurances Archived : </h2>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($treatments as $index => $treatment)
                                    <tr>
                                        ...
                                        <td  style="text-align: center">
                                                ...
                                                <a href="{{ route('super_admin.insurances-softDeleteRestore', $treatment->id) }}" class="unarchive mb-1 btn btn-sm btn-success"><i
