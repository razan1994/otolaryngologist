                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item" aria-current="page">All insurances</li>
                        </ol>
                    </nav>
                </div>
                <div>
                    <a href="{{ route('super_admin.insurances-create') }}" class="mb-1 btn btn-primary"><i
                            class="mdi mdi-playlist-plus"></i> Add New</a>


                            <a href="{{ route('super_admin.insurances-showSoftDelete') }}" class="mb-1 btn btn-danger"><i
                                ...
                                @foreach ($treatments as $index => $treatments)
                                    ...
                                    @endif
                                        ...
                                        <td  style="text-align: center">
                                            ...
                                            <a href="{{ route('super_admin.insurances-show', $treatments->id) }}"
                                                class="mb-1 btn btn-sm btn-primary"><i class="mdi mdi-eye"></i></a>

                                            <a href="{{ route('super_admin.insurances-edit', $treatments->id) }}"
                                                class="mb-1 btn btn-sm btn-success"><i
                                                    class="mdi mdi-playlist-edit"></i></a>


                                            <a href="{{ route('super_admin.insurances-softDelete', $treatments->id) }}"
