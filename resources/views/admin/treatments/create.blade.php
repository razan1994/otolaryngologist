    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                {{-- ============================================== --}}
                <div>
                    <h1>Add New Treatment/Service</h1>
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.treatments-index') }}">
                                    <i class="far fa-newspaper"></i></span> All Treatment/Services
                                </a>
                            </li>
                            ...
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    <div class="card-header card-header-border-bottom">
                                        <h2> Add New Treatment/Service:</h2>
                                    </div>
                                    <div class="card-body">
                                        <form action="{{ route('super_admin.treatments-store') }}" method="POST"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <label class="text-dark font-weight-medium mb-3" > Treatment Details AR :
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <label class="text-dark font-weight-medium mb-3" > Treatment Details EN :
