                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.Photo-index') }}">
                                    <i class="far fa-newspaper"></i></span> All Photo
                                </a>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('super_admin.Photo-store') }}" method="POST"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01"> Image Before<strong
                                                            class="text-danger">
                                                            * @error('image1') - {{ $message }}
                                                            @enderror</strong></label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="text-dark font-weight-medium mb-3"
                                                        for="validationServer01"> Image After<strong
                                                            class="text-danger">
                                                            * @error('image') - {{ $message }}
                                                            @enderror</strong></label>
                                                    <div class="input-group">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <label class="text-dark font-weight-medium mb-3" > Before & After Details AR :
                                                        <strong class="text-danger"> * @error('desc_ar') - {{ $message }} @enderror</strong>
                                                    </label>
                                                    <textarea id="desc_ar" name="desc_ar" rows="50" class="form-control ">{{ old('desc_ar') }}</textarea>
                                                </div>

                                                {{-- @lang('front_end.News_Blog_Details_EN') --}}
                                                <div class="col-md-12 mb-3">
                                                    <label class="text-dark font-weight-medium mb-3" > Before & After Details EN :
                                                        <strong class="text-danger">* @error('desc_en') - {{ $message }}@enderror</strong>
                                                    </label>
                                                    <textarea id="desc_en" name="desc_en" rows="50" class="form-control" rows="10">{{ old('desc_en') }}</textarea>
                                                </div>
                                                @if(Auth::user()->id == 1)
                                                 {{-- alt text Ar --}}
                                                 <div class="col-md-6 mb-3">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="h1_val_ar" class="form-control @error('h1_val_ar') is-invalid @enderror"
                                                            id="validationServer01" placeholder="H1 AR"
                                                            value="{{ old('h1_val_ar') }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea name="tags" class="form-control" placeholder="enter , after your tag">{{ old('tags') }}</textarea>
                                                </div>
                                                @endif
