                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item" aria-current="page">All Photo</li>
                        </ol>
                    </nav>
                </div>
                <div>
                    <a href="{{ route('super_admin.Photo-create') }}" class="mb-1 btn btn-primary"><i
                            class="mdi mdi-playlist-plus"></i> Add New</a>


                            <a href="{{ route('super_admin.Photo-showSoftDelete') }}" class="mb-1 btn btn-danger"><i
                    ...
                    <table id="hoverable-data-table" class="table table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center"><i class="mdi mdi-image"></i>Image Before </th>
                                <th style="text-align: center"><i class="mdi mdi-image"></i>Image After </th>
                                ...
                                @foreach ($news_blogs as $index => $news_blog)
                                    <tr>
                                        ...
                                        @if ($news_blog->image_before && file_exists($news_blog->image_before))
                                            <td  style="text-align: center"><img src="{{ asset($news_blog->image_before) }}" width="70" height="70"
                                        ...
                                        <td  style="text-align: center"><img src="{{ asset($news_blog->image_after) }}" width="70" height="70"
                                                style="border-radius: 10px; border:solid 1px black;"></th>
                                        @else
                                        <td  style="text-align: center"><img src="{{ asset('images_default/default.jpg') }}" width="70" height="70"
                                                style="border-radius: 10px; border:solid 1px black;"></th>
                                    @endif
                                        ...
                                        <td  style="text-align: center">
                                            ...
                                            <a href="{{ route('super_admin.Photo-show', $news_blog->id) }}"
                                                class="mb-1 btn btn-sm btn-primary"><i class="mdi mdi-eye"></i></a>

                                            <a href="{{ route('super_admin.Photo-edit', $news_blog->id) }}"
                                                class="mb-1 btn btn-sm btn-success"><i
                                                    class="mdi mdi-playlist-edit"></i></a>


                                            <a href="{{ route('super_admin.Photo-softDelete', $news_blog->id) }}"
