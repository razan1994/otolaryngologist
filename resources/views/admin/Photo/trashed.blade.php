                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item" aria-current="page" ><i class="mdi mdi-delete"></i> All Photo Archived </li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                @foreach ($news_blogs as $index => $news_blog)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            {{ isset($news_blog->deleted_at) ? $news_blog->deleted_at : "<span style='color:red;'>Undefined</span>" }}
                                        </td>
                                        <td  style="text-align: center">


                                                <a href="{{ route('super_admin.Photo-softDeleteRestore', $news_blog->id) }}" class="unarchive mb-1 btn btn-sm btn-success"><i
