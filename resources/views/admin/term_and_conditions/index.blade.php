                                ...
                                @foreach ($term_and_conditions as $index => $term_and_condition)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{ route('super_admin.term_and_conditions-show', $term_and_condition->id) }}"
                                                class="mb-1 btn btn-sm btn-primary"><i class="mdi mdi-eye"></i></a>

                                            <a href="{{ route('super_admin.term_and_conditions-edit', $term_and_condition->id) }}"
                                                class="mb-1 btn btn-sm btn-success"><i
                                                    class="mdi mdi-playlist-edit"></i></a>


                                            <a href="{{ route('super_admin.term_and_conditions-softDelete', $term_and_condition->id) }}"
