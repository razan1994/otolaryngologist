                    ...
                    <table id="hoverable-data-table" class="table table-hover table-striped">
                        ...
                        <tbody>
                            @if (isset($operations))
                                ...
                                <tr>
                                    <td  style="text-align: center">{{ isset($operation->page_name) ? $operation->page_name : 'Undefined' }}</td>
                                    <td  style="text-align: center">{{ isset($operation->user->name) ? $operation->user->name : 'Undefined' }}</td>

                                    <td style="text-align: center">
                                        {{ isset($operation->updated_at) ? $operation->updated_at : "<span style='color:red;'>Undefined</span>" }}
                                    </td>

                                    <td  style="text-align: center">{{ isset($operation->h1_val_en) ? $operation->h1_val_en : 'Undefined' }}</td>
                                    ...
                                    <td  style="text-align: center">
                                        <a href="{{ route('super_admin.seo_operations-edit', $operation->id) }}"
