        ...
        <div class="form-row">
            ...
            <div class="col-md-6 mb-3">
                <label class="text-dark font-weight-medium mb-3" for="first_name">
                    ...
                    <strong class="text-danger"> * @error('first_name')
                            ( {{ $message }} )
                        @enderror
                    </strong>
                </label>
            ...
            <div class="col-md-3 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" wire:model.live="country_key"
                        class="form-control @error('country_key') is-invalid @enderror" id="country_key"
                        placeholder="+962">
                </div>
            </div>
            ...
            <div class="col-md-6 mb-3">
                <label class="text-dark font-weight-medium mb-3" for="appointment_type_id">
                    ...
                    <strong class="text-danger"> * @error('appointment_type_id')
                            ( {{ $message }} )
                        @enderror
                    </strong>
                </label>
                <div class="input-group">
                    ...
                    <select wire:model.live="appointment_type_id"
                        class="custom-select my-1 mr-sm-2 @error('appointment_type_id') is-invalid @enderror"
            ...
            <div class="col-md-4 mb-3">
                <label class="text-dark font-weight-medium mb-3" for="appointment_date">
                    ...
                    <strong class="text-danger"> * @error('appointment_date')
                            ( {{ $message }} )
                        @enderror
                    </strong>
                </label>
                <div class="input-group">
                    ...
                    <input type="date" wire:model.live="appointment_date"
                        class="form-control @error('appointment_date') is-invalid @enderror" id="appointment_date">
                </div>
            </div>
                    ...
                    @elseif(!empty($availableSlots))
                        <div class="input-group mb-2">
                            ...
                            <select wire:model.live="start_time"
                                class="custom-select @error('start_time') is-invalid @enderror">
            ...
            <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                    ...
                    <select wire:model.live="status"
                        class="custom-select my-1 mr-sm-2 @error('status') is-invalid @enderror" id="status">
            ...
            <div class="col-12 mb-3">
                ...
                <div class="input-group">
                    ...
                    <textarea style="width: 90% !important" wire:model.live="notes"
                        class="form-control @error('notes') is-invalid @enderror" rows="4" placeholder="Additional notes"></textarea>
                </div>
            </div>
