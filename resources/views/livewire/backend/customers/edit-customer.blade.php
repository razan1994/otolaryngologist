<div>
    <form wire:submit.prevent="update" id="updateForm">
        <div class="form-row">
            ...
            <div class="col-md-6 mb-3">
                <label class="text-dark font-weight-medium mb-3" for="password">
                    <i class="mdi mdi-lock"></i> Password : <small class="text-muted">(Leave blank to keep current)</small> @error('password') <strong class="text-danger">{{ $message }}</strong> @enderror
                </label>
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text mdi mdi-lock" id="inputGroupPrepend2"></span>
                    </div>
                    <input type="password" wire:model="password" class="form-control @error('password') is-invalid @enderror" id="password" placeholder="New Password">
                </div>
            </div>
            ...
            <div class="col-md-6 mb-3">
                <label class="text-dark font-weight-medium mb-3" for="password_confirmation">
                    <i class="mdi mdi-lock-check"></i> Confirm Password :
                </label>
                <div class="input-group">
                    <div class="input-group-prepend">
