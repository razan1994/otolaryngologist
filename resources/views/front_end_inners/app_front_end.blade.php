        ...
        <div class="container-md position-relative  d-flex flex-nowrap align-items-center justify-content-between">
                ...
                @if (Config::get('app.locale') == 'en')
                    <a href="{{ route('welcome') }}">
                        <img src="{{ asset('front_end_style/assets/img/home1/logo.png') }}"
                            alt="Company Logo English" class="img-fluid">
                    </a>
                @else
                    <a href="{{ route('welcome') }}">
            ...
            <div class="company-logo d-lg-flex d-none">
                @if (Config::get('app.locale') == 'en')
                    <a href="{{ route('welcome') }}">
                        <img src="{{ asset('front_end_style/assets/img/home1/logo.png') }}"
                            alt="Company Logo English">
                    </a>
                @else
                    <a href="{{ route('welcome') }}">
                        <img src="{{ asset('front_end_style/assets/img/home1/logo_ar.png') }}" alt="شعار الشركة">
                    </a>
                @endif
            </div>
            <div class="main-menu">
                    ...
                    <div class="col-lg-3 col-sm-6 d-flex justify-content-lg-start justify-content-sm-end">
                        <div class="footer-widget">
                            ...
                            <ul class="widget-list">
                                ...
                                <li><a href="tel:+9962799559157">{{ __('front_end.footer_Phone') }} {{ __('front_end.footer_No') }}</a>
                                </li>
                    ...
                    <div
                        ...
                        <div class="footer-widget">
                            ...
                            <ul class="widget-list">
                                ...
                                <li><a href="{{ route('Terms&Conditions') }}">{{ __('front_end.footer_terms') }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
