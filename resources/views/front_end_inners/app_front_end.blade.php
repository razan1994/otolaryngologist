...
<head>
    ...
    $treatments = App\Models\Treatment::latest()->get();
    ?>
    ...
    <header class="header-area style-2">
        <div class="container-md position-relative  d-flex flex-nowrap align-items-center justify-content-between">
            <div class="header-logo d-lg-none d-flex">
                ...
                @else
                    <a href="{{ route('welcome') }}">
                        <img src="{{ asset('front_end_style/assets/img/home1/logo_ar.png') }}" class="img-fluid" alt="شعار الشركة">
                    </a>
                @endif
            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-widget">
                            <div class="widget-title">
                                <h6 style="color: #fff"> {{ __('front_end.top_nav_text') }}</h6>
                            </div>
                            ...
                            <ul class="widget-list">
                                ...
                                <li><a href="tel:+9962799559157">{{ __('front_end.footer_Phone') }}+9962799559157</a>
                                </li>
                                <li><a href="dranasabushamleh82@gmail.com">{{ __('front_end.footer_Email') }}

                                        dranasabushamleh82@gmail.com</a></li>
                            </ul>
