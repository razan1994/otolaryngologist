...
<head>
    ...
    <title>E-Commerce For IT Solutions</title>
    ...
    <div class="flex-center position-ref full-height">
        <div class="content">
            <div class="title m-b-md ">
                <img class="img-thumbnail image-preview " style="border: 1px solid #3ea23e; width: 20% !important;" src="{{ asset('images_default/category.jpg') }}" alt="">
            </div>
            <div class="m-b-md-12">
                <h1 style="color: blue;">E-Commerce For IT Solutions</h1>
                <hr>
                ...
                <h2 style="color: royalblue;">Mobile : +962788823233 || E-mail : support@ecs.com</h2>
